<?php
/**
 * PNFW_Migration_OneSignal Test Bootstrapper.
 *
 * @since   0.1.0
 ...
 * @since 0.1.0
 */
function _manually_load_pnfw_migration_onesignal_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/pnfw-migration-onesignal.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_pnfw_migration_onesignal_plugin' );
